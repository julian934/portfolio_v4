...
const Modal = (props: Props) => {
  return (
    <div className='relative max-sm:top-8 md:min-h-[60vw] max-sm:px-4' >
        ...
        <div className={props.gam3rs==true || props.etq==true?'relative max-sm:max-w-[250px] md:top-24 md:left-24 md:min-w-[400px] z-30 border-2 border-black bg-white':'relative max-sm:max-w-[250px] md:top-28 md:-left-6 z-50 md:min-w-[400px]  '} >
